...
The final condition is essential. Removing an admitted WIR v1 form is a contract
change even when current `weavec1` sources do not use it. Such removals must be
